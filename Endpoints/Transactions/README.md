...
| subtotal_amount                 | number     |     | 10    |               | ✔            |             |      | This field is allowed and required for transactions that have a product where surcharge is configured. This amount should not include the value of the "tax" field (sales tax) if present.                                                                                                                                                                                                                                                                                                     |
