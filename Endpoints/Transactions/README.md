...
| billing_state                   | string     |     | 26     |               | ✔            |             | N    | The State portion of the address associated with the Credit Card (CC) or Bank Account (ACH).                                                                                                                                                                                                                                                                                                               |
...
| locale                          | string     | 5    |       |               | ✔            |           |    | Value used "en_CA" to indicate "English Canada" in order to enable Canadian-specific labels.                                                                                                                                                                                                                                                              |
