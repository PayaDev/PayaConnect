...
-----------------------------------------------*/
  ...
  // Used to create a Integration Users ONLY with Paya Connect APIs.
  // Additional location users must be createed in the Paya Connect UI.
  // More details on this request can be found at 
  // https://docs.payaconnect.com/developers/api/endpoints/users
  ...
  // Build Payload
  $request = file_get_contents('integrationuserpayload.json');
