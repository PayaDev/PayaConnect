...
| billing_state                 | 2   | 26   | string  |               | ✔            | ✔           | The State portion of the address associated with the Credit Card (CC) or Bank Account (ACH).                                                                                                                                                                                                                     |
...
| locale                        |   5 | 5    | string |               | ✔            |     | Value used "en_CA" to indicate "English Canada" in order to enable Canadian-specific labels.                                                                                                                                                                                                                     |
