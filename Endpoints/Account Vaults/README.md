...
| locale                        |   5 | 5    | string | ✔              | ✔            |     | Value used "en_CA" to indicate "English Canada" in order to enable Canadian-specific labels. **Only required for Canadian Merchant Processing**                                                                                                                                                                                                                    |
